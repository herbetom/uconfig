...
set ieee8021x.@config[-1].ca='/etc/uconfig/certificates/ca.pem'
set ieee8021x.@config[-1].cert='/etc/uconfig/certificates/cert.pem'
set ieee8021x.@config[-1].key='/etc/uconfig/certificates/cert.key'
{%	if (ieee8021x.mode == "radius"): %}
